...
state_labels <- c(
  "1" = "Alabama", "2" = "Arkansas", "3" = "California",
  "4" = "Colorado", "5" = "Connecticut", "6" = "Delaware",
  "7" = "Georgia", "8" = "Idaho", "9" = "Illinois",
  "10" = "Indiana", "11" = "Iowa", "12" = "Kansas",
  "13" = "Kentucky", "14" = "Louisiana", "15" = "Maine",
  "16" = "Minnesota", "17" = "Mississippi", "18" = "Missouri",
  "19" = "Montana", "20" = "Nebraska", "21" = "Nevada",
  "22" = "New Hampshire", "23" = "New Mexico", "24" = "North Carolina",
  "25" = "North Dakota", "26" = "Ohio", "27" = "Oklahoma",
  "28" = "Pennsylvania", "29" = "Rhode Island", "30" = "South Carolina",
  "31" = "South Dakota", "32" = "Tennessee", "33" = "Texas",
  "34" = "Utah", "35" = "Vermont", "36" = "Virginia",
...
smoking$state_name <- unname(state_labels[as.character(smoking$state)])
...
stopifnot(
  ...
  !anyNA(smoking$state_name)
)

print(unique(smoking[c("state", "state_name")]))
